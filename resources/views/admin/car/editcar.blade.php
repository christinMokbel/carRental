								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('updatecar', $car->id) }}" method="post" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="doors" class="form-control" type="number" name="door" required="required" value="{{ $car->door }}">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{ asset('assets/front/images/'.$car->image) }}" alt="" style="width: 300px;">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
                                                ...
                                                @foreach($categories as $category)
													...
													<option value="{{ $category->id }}" @selected($category->id == $car->category_id) > {{ $category->category }} </option>
												@endforeach
												</select>
											</div>
										</div>
