                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      @foreach($cars as $car)
                        ...
                        <tr>
                          ...
                          <td><a href="{{ route('deletecar',['id'=> $car->id]) }}" onclick="return confirm('Are you sure you want to delete?')"><img src="{{ asset('assets/admin/images/delete.png') }}" alt="Delete"></a></td>
                        </tr>
                        @endforeach
